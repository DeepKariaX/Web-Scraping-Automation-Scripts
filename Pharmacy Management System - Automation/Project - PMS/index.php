  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-light sticky-top" data-navbar-darken-on-scroll="900">
        <div class="container pt-2"><a class="navbar-brand" href="index.php"> <h3>PMS</h3> </a>
          <div class="navbar-nav ms-auto">
            <button class="btn btn-secondary" onclick="location.href='users/main/login.php'">Login</button>
          </div>
        </div>
      </nav>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-9 col-lg-8 col-xl-5">
              <h1 class="display-3 lh-sm">Pharmacy Management System</h1>
            </div>
            <div class="col-md-9 col-xl-5">
              <p class="fs-2">Pharmacists have and will continue to affect in positive ways our nation's health care system and lead from many types of positions and in many practice settings.</p>
              <button class="btn btn-primary mt-3"> - Paul W. Abramowitz</button>
            </div>
          </div>
        </div>
        <!-- end of .container-->
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xl-5 pt-2 pt-xl-0 text-center text-xl-end">
              <p class="mb-0">Made By Group 15</p>
            </div>
          </div>
        </div>

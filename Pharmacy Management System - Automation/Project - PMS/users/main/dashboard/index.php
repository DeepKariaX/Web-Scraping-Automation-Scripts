...
<body>
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"> PMS</h3>
        ...
        <div class="container">
            ...
            <div class="manager">
                ...
                <?php if ( 'editManager' == $action ) {
                        ...
                        $result=$conn->query($selectManagers);
                ...
                <?php if ( 'deleteManager' == $action ) {
                        ...
                        $result=$conn->query($deleteManager);
            ...
            <div class="pharmacist">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $getPharmacist = "SELECT * FROM pharmacists";
                                            $result=$conn->query($getPharmacist);
                ...
                <?php if ( 'editPharmacist' == $action ) {
                        ...
                        $result=$conn->query($selectPharmacist);
                ...
                <?php if ( 'deletePharmacist' == $action ) {
                        ...
                        $result=$conn->query($deletePharmacist);
            ...
            <div class="salesman">
                ...
                <?php if ( 'editSalesman' == $action ) {
                        ...
                        $result=$conn->query($selectSalesman);
                ...
                <?php if ( 'deleteSalesman' == $action ) {
                        ...
                        $result=$conn->query($deleteSalesman);
